...
<html lang="fr-CM">
    ...
    <?php $valeur ="ajustement_de_stock";?>
                                ...
                                <div class="dataTable-container">
                                    <?php
                                        ...
                                        function getUtilisateurs() {
                                            ...
                                            $query = "SELECT utilisateurs.id_utilisateurs, utilisateurs.username, personnels.nom_personnels, personnels.prenom_personnels  
                                                      FROM utilisateurs 
                                    ...
                                    <table id="myTable2" class="whitespace-nowrap dataTable-table">
                                        <thead>
                                            <tr>
                                               <th data-sortable="" style="width: 20.4881%;">Nom personnel</t> 
                                               <th data-sortable="" style="width: 20.4881%;">Prenom personnel</th>
                                               <th data-sortable="" style="width: 20.4881%;">ID utilisateur</th>
                                               <th data-sortable="" style="width: 20.4881%;">Nom d'utilisateur</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($utilisateurs as $row):?> 
                                                <tr>
                                                    <td><?php echo htmlspecialchars($row["nom_personnels"]); ?></td>
                                                    ...
                                                    <button type=\"button\" class=\"ltr:mr-2 rtl:ml-2\" x-tooltip=\"Modifier\">
                                                        <a href=\"editer_un_utilisateur.php?id=$row[id_utilisateurs]\">
                                                    ...
                                                    <button type=\"button\" x-tooltip=\"Supprimer\" onClick=\"showAlert$row[id_utilisateurs]()\">
                                                    <script>
                                                    async function showAlert$row[id_utilisateurs]() {
                                                        new window.Swal({
                                                            icon: 'warning',
                                                            ...
                                                            if (result.value) {
                                                                ...
                                                                setTimeout(function() {
                                                                    window.location.href = \"supprimer_un_utilisateur.php?id=$row[id_utilisateurs]\";
                                                                  }, 1000);
                                                            }
                                                        });
                                                    }
