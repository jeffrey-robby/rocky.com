        ...
        <div class="content-inner container-fluid pb-0" id="page_layout"> 
         ...
         <div class="card-header d-flex justify-content-between">
            <div class="header-title">
               <h4 class="card-title">Lieux de Stockages</h4>
            </div>
         </div>
         <div class="card-body">
            ...
            <div class="table-responsive custom-table-search">
               <table id="datatable" class="table table-striped " data-toggle="data-table">
                  <thead>
                     <tr>
                        <th>Nom</th>
                        <th>Quantité de Produit Stocké</th>
                        <th>Operation</th>
                  ...
                  <tbody>
                    ...
                    $request = mysqli_query($database, "
                        SELECT 
                            stocks.nom_stocks,
                            stocks.id_stocks, 
                            IFNULL(SUM(quantite_en_stocks.quantite_quantite_en_stocks), 0) AS sumq 
                        FROM 
                            stocks 
                        LEFT JOIN 
                            quantite_en_stocks 
                    ...
                    while ($result = mysqli_fetch_assoc($request)) {
                        echo '
                        <tr>
                            <td>'.$result['nom_stocks'].'</td>
                            <td>'.$result['sumq'].'</td>
                            <td><a class="icons-list d-flex align-items-center gap-3" href="?delS='.$result['id_stocks'].'"><i class="fa fa-trash" aria-hidden="true"></i>supprimer</a></td>
