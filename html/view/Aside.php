                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                            ...
                            <i class="sidenav-mini-icon" data-bs-toggle="tooltip"
                                title="Acceuil" data-bs-placement="right">HP</i>
                    ...
                    <li class="nav-item iq-drop active">
                        <a class="nav-link" data-bs-toggle="collapse" href="#store"
                            ...
                            <span class="item-name">Librairie</span>
                            <i class="right-icon">
                        ...
                        <ul class="sub-nav collapse" id="store" data-bs-parent="#sidebar-menu">
                            <li class="nav-item iq-drop">
                                <a class="nav-link" data-bs-toggle="collapse" href="#menulevel"
                                    ...
                                    <span class="item-name">Catégories Produits</span>
                                    <i class="right-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18"
                                            class="icon-18" fill="none" viewBox="0 0 24 24"
                                            stroke="currentColor">
                                ...
                                <ul class="sub-nav collapse" id="menulevel">
                                    <li class="nav-item">
                                        <a
                                            ...
                                            data-bs-target=".addCat">Ajouter</span>
                                        </a>
                                    </li>
                                    <li class="nav-item iq-drop">
                                        <a
                                            class="nav-link "
                                            aria-current="page" href="../shop/category-page.php">
                                            ...
                                            <span class="item-name">Afficher</span>
                                        </a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="collapse" href="#menufournisseurs"
                                    role="button" aria-expanded="false">
                                    <i class="icon" data-bs-toggle="tooltip" title="Menu Level"
                                        data-bs-placement="right">
                                        <i class="ph-duotone ph-text-indent"></i>
                                ...
                                <ul class="sub-nav collapse" id="menufournisseurs">
                                    <li class="nav-item">
                                        <a
                                            class="nav-link "
                                            aria-current="page" href="#">
                                            ...
                                            <i class="sidenav-mini-icon" data-bs-toggle="tooltip"
                                                title="Menu 1" data-bs-placement="right">AJ</i>
                                            <span class="item-name" data-bs-toggle="modal"
                                            data-bs-target=".addFour">Ajouter</span>
                                        </a>
                                    </li>
                                    <li class="nav-item iq-drop">
                                        <a
                                            class="nav-link "
                                            aria-current="page" href="../shop/fournisseur.php">
                                            <i class="icon" data-bs-toggle="tooltip" title="Liste des Categories"
                                                data-bs-placement="right">
                                                <i class="ph-duotone ph-list"></i>
                                            </i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="collapse" href="#menustock"
                                    role="button" aria-expanded="false">
                                    <i class="icon" data-bs-toggle="tooltip" title="Menu Level"
                                        data-bs-placement="right">
                                        <i class="ph-duotone ph-text-indent"></i>
                                    ...
                                    <span class="item-name">Lieux de Stockage</span>
                                    <i class="right-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18"
                                            class="icon-18" fill="none" viewBox="0 0 24 24"
                                            stroke="currentColor">
                                ...
                                <ul class="sub-nav collapse" id="menustock">
                                    <li class="nav-item">
                                        <a
                                            class="nav-link "
                                            aria-current="page" href="#">
                                            ...
                                            <i class="sidenav-mini-icon" data-bs-toggle="tooltip"
                                                title="Menu 1" data-bs-placement="right">AJ</i>
                                            <span class="item-name" data-bs-toggle="modal"
                                            data-bs-target=".addStock">Ajouter</span>
                                        </a>
                                    </li>
                                    <li class="nav-item iq-drop">
                                        <a
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-nav collapse" id="menuproduit">
                                    <li class="nav-item">
                                        <a
                                            class="nav-link "
                                            aria-current="page" href="#">
                                            ...
                                            <i class="sidenav-mini-icon" data-bs-toggle="tooltip"
                                                title="Menu 1" data-bs-placement="right">AJ</i>
                                            <span class="item-name" data-bs-toggle="modal"
                                            data-bs-target=".addProd">Ajouter</span>
                                        </a>
                                    </li>
                                    <li class="nav-item iq-drop">
                                        <a
                                            class="nav-link "
                                            aria-current="page" href="../shop/produits.php">
                                            <i class="icon" data-bs-toggle="tooltip" title="Liste des Categories"
                                                data-bs-placement="right">
                                                <i class="ph-duotone ph-list"></i>
                                            </i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="collapse" href="#menupersonnels"
                                    role="button" aria-expanded="false">
                                    <i class="icon" data-bs-toggle="tooltip" title="Menu Level"
                                        data-bs-placement="right">
                                        <i class="ph-duotone ph-text-indent"></i>
                                    ...
                                    <span class="item-name">Personnels</span>
                                    <i class="right-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18"
                                            class="icon-18" fill="none" viewBox="0 0 24 24"
                                            stroke="currentColor">
                                ...
                                <ul class="sub-nav collapse" id="menupersonnels">
                                    <li class="nav-item">
                                        <a
                                            class="nav-link "
                                            aria-current="page" href="#">
                                            ...
                                            <i class="sidenav-mini-icon" data-bs-toggle="tooltip"
                                                title="Menu 1" data-bs-placement="right">AJ</i>
                                            <span class="item-name" data-bs-toggle="modal"
                                            data-bs-target=".addPers">Ajouter</span>
                                        </a>
                                    </li>
                                    <li class="nav-item iq-drop">
                                        <a
                                            class="nav-link "
                                            aria-current="page" href="../shop/personnel.php">
                                            <i class="icon" data-bs-toggle="tooltip" title="Liste des Categories"
                                                data-bs-placement="right">
                                                <i class="ph-duotone ph-list"></i>
                                            </i>
