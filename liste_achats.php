                ...
                <div class="animate__animated p-6 animate__fadeInDown">
                    ...
                    <div x-data="multipleTable">
                        <div class="panel mt-6">
                            <h5 class="md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light">Achats</h5>
                            ...
                            <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns" id="abId0.3250869166938237">
                                ...
                                <div class="dataTable-container">
                                    ...
                                    <table id="myTable2" class="whitespace-nowrap dataTable-table">
                                        <thead>
                                            <tr>
                                               <th data-sortable="" style="width: 22.8532%;">Total d'achat</th>
                                               <th data-sortable="" style="width: 22.8532%;">Crédit</th>
                                               <th data-sortable="" style="width: 22.2901%;">Date d'achat</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($ventes as $row): ?>
                                                <tr>
                                                    <td><?php echo htmlspecialchars($row["total_achats"]); ?> <b>FCFA</b></td>
                                                    <td><?php echo htmlspecialchars($row["reste_achats"]); ?> <b>FCFA</b></td>
                                                    <td><?php echo htmlspecialchars($row["created_at_achats"]); ?></td>
                                                    <td><?php  echo "<div class=\"flex items-center\">
                                                    
                                                    <button type=\"button\" class=\"ltr:mr-2 rtl:ml-2\" x-tooltip=\"Voir\">
                                                        <a href=\"liste_achats_par_produit.php?id=$row[id_achats]\">
                                                    ...
                                                    <button type=\"button\" x-tooltip=\"Annuler l'achat\" style=\"color: red;\" onClick=\"showAlert$row[id_achats]()\">
                                                    <script>
                                                    async function showAlert$row[id_achats]() {
                                                        new window.Swal({
                                                            icon: 'warning',
                                                            title: 'Êtes-vous sûr de vouloir annuler cet achat ?',
                                                            ...
                                                            if (result.value) {
                                                                new window.Swal('Supprimer !', 'Lachat a été annulé.', 'success');
                                                                setTimeout(function() {
                                                                    window.location.href = \"supprimer_un_achat.php?id=$row[id_achats]\";
                                                                  }, 1000);
                                                            }
                                                        });
                                                    }
