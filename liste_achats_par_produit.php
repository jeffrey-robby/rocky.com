                ...
                <div class="animate__animated p-6 animate__fadeInDown">
                    ...
                    <div>
                        <ul class="flex space-x-2 rtl:space-x-reverse">
                            <li>
                                <a href="liste_achats.php" class="text-primary hover:underline">Liste d'achats</a>
                            </li>
                            <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
                                <span>Liste de produit par achat</span>
                            </li>
                        </ul>
                        ...
                        <div class="panel mt-6">
                            ...
                            <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns" id="abId0.3250869166938237">
                                ...
                                <div class="dataTable-container">
                                    <?php
                                        function getVenteProduit() {
                                            $pdo = getConnection();
                                        
                                            $id_vente = $_REQUEST['id'];
                                        
                                            $query = " SELECT 
                                                ventes_produits.id_ventes,
                                                ventes_produits.quantite_ventes_produits, 
                                                ventes_produits.prix_ventes_produits, 
                                            ...
                                            FROM 
                                                ventes_produits 
                                            JOIN 
                                                produits ON ventes_produits.id_produits = produits.id_produits 
                                            JOIN 
                                                ventes ON ventes_produits.id_ventes = ventes.id_ventes
                                            JOIN 
                                                dettes_clients ON ventes.id_clients = dettes_clients.id_clients
                                            WHERE 
                                                ventes_produits.id_ventes = :id_vente
                                           ";
                                        
                                            $stmt = $pdo->prepare($query);
                                            
                                            // Lier le paramètre id_vente à la requête
                                        ...
                                        $venteProduit = getVenteProduit();
                                    ?>
                                    <table id="myTable2" class="whitespace-nowrap dataTable-table">
                                        <thead>
                                            <tr>
                                               <th data-sortable="" style="width: 20.4881%;">Nom produit</th>
                                               <th data-sortable="" style="width: 20.4881%;">Quantité acheté</th>
                                               <th data-sortable="" style="width: 22.8532%;">Prix d'achat</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php foreach ($venteProduit as $row): ?>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td><?php echo htmlspecialchars($row["quantite_ventes_produits"]); ?></td>
                                                    <td><?php echo htmlspecialchars($row["prix_ventes_produits"]); ?> <b>FCFA</b></td>
