                ...
                <div class="animate__animated p-6 animate__fadeInDown">
                    ...
                    <div>
                        <ul class="flex space-x-2 rtl:space-x-reverse">
                            <li>
                                <a href="liste_de_vente.php" class="text-primary hover:underline">Liste de vente</a>
                            </li>
                            <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
                                <span>Liste de produit par vente</span>
                            </li>
                        </ul>
                                    ...
                                    <table id="myTable2" class="whitespace-nowrap dataTable-table">
                                        <thead>
                                            <tr>
                                               ...
                                               <th data-sortable="" style="width: 20.4881%;">Quantité vendu</th>
                                               <th data-sortable="" style="width: 22.8532%;">Prix de vente</th>
                                            </tr>
                                        </thead>
                                        <tbody>
