                ...
                <div class="animate__animated p-6 animate__fadeInDown">
                    ...
                    <div x-data="multipleTable">
                        <div class="panel mt-6">
                            <h5 class="md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light">Liste des clients</h5>
                            ...
                            <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns" id="abId0.3250869166938237">
                                ...
                                <div class="dataTable-container">
                                    <?php
                                    // Récupérer les données de la table clients et la somme des dettes
                                    function getClients() {
                                        $pdo = getConnection();
                                        ...
                                        $query = "
                                            SELECT 
                                                clients.nom_clients, 
                                                clients.id_clients, 
                                                clients.prenom_clients, 
                                                clients.tel_clients, 
                                                clients.point_de_fidelite_clients, 
                                                clients.type_clients, 
                                                clients.residence_clients, 
                                                COALESCE(SUM(dettes_clients.montant_dettes_clients), 0) AS montant_dettes_clients,
                                                COALESCE(SUM(dettes_clients.avance_dettes_clients), 0) avance_dettes_clients,
                                                COALESCE(SUM(ventes.total_ventes), 0) AS total_ventes
                                            FROM 
                                                clients 
                                            LEFT JOIN 
                                                dettes_clients ON clients.id_clients = dettes_clients.id_clients
                                            LEFT JOIN 
                                                ventes ON dettes_clients.id_ventes = ventes.id_ventes
                                            WHERE 
                                                clients.id_clients != 1  -- Exclure le client avec l'ID 1
                                            GROUP BY 
                                                clients.id_clients
                                        ";
                                    ...
                                    <table id="myTable2" class="whitespace-nowrap dataTable-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-sortable="" style="width: 20.4881%;">Prénom</th>
                                                <th data-sortable="" style="width: 20.4881%;">Téléphone</th>
                                                <th data-sortable="" style="width: 20.4881%;">Type de client</th>
                                                <th data-sortable="" style="width: 20.4881%;">Dettes</th>
                                                <th data-sortable="" style="width: 20.4881%;">Avance dettes</th>
                                                <th data-sortable="" style="width: 20.4881%;">Recettes</th>
                                                <th data-sortable="" style="width: 20.4881%;">Résidence</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($clients as $row): ?> 
                                                <tr>
                                                    ...
                                                    <td><?php echo htmlspecialchars($row["prenom_clients"]); ?></td>
                                                    <td><?php echo htmlspecialchars($row["tel_clients"]); ?></td>
                                                    <td><?php echo htmlspecialchars($row["type_clients"]); ?></td>
                                                    ...
                                                    <button type=\"button\" class=\"ltr:mr-2 rtl:ml-2\" x-tooltip=\"Voir\">
                                                        <a href=\"voir_un_client.php?id=$row[id_clients]\">
                                                    ...
                                                    <button type=\"button\" x-tooltip=\"Supprimer\" onClick=\"showAlert$row[id_clients]()\">
                                                    <script>
                                                    async function showAlert$row[id_clients]() {
                                                        new window.Swal({
                                                            icon: 'warning',
                                                            ...
                                                            if (result.value) {
                                                                ...
                                                                setTimeout(function() {
                                                                    window.location.href = \"supprimer_un_client.php?id=$row[id_clients]\";
                                                                  }, 1000);
                                                            }
                                                        });
                                                    }
