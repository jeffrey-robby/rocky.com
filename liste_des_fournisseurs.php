...
<html lang="fr-CM">
    ...
    <?php $valeur ="liste_des_fournisseurs";?>
                ...
                <div class="animate__animated p-6 animate__fadeInDown">
                    ...
                    <div x-data="multipleTable">
                        <div class="panel mt-6">
                            <h5 class="md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light">Liste des fournisseurs</h5>
                                    ...
                                    <table id="myTable2" class="whitespace-nowrap dataTable-table">
                                        ...
                                        <tbody>
                                            <?php foreach ($fournisseurs as $row):?> 
                                                <tr>
                                                    <td><?php echo htmlspecialchars($row["id_fournisseurs"]); ?></td>
                                                    <td><?php echo htmlspecialchars($row["nom_fournisseurs"]); ?></td>
                                                    <td><?php echo htmlspecialchars($row["tel_fournisseurs"]); ?></td>
                                                    <td><?php echo htmlspecialchars($row["residence_fournisseurs"]); ?></td>
                                                    <td><?php  echo "<div class=\"flex items-center\">
                                                    <button type=\"button\" class=\"ltr:mr-2 rtl:ml-2\" x-tooltip=\"Modifier\">
                                                        <a href=\"editer_un_fournisseur.php?id=$row[id_fournisseurs]\">
                                                    ...
                                                    <button type=\"button\" x-tooltip=\"Supprimer\" onClick=\"showAlert$row[id_fournisseurs]()\">
                                                    <script>
                                                    async function showAlert$row[id_fournisseurs]() {
                                                        new window.Swal({
                                                            icon: 'warning',
                                                            ...
                                                            if (result.value) {
                                                                ...
                                                                setTimeout(function() {
                                                                    window.location.href = \"supprimer_un_fournisseur.php?id=$row[id_fournisseurs]\";
                                                                  }, 1000);
                                                            }
                                                        });
                                                    }
