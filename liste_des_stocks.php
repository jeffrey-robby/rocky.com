                ...
                <div class="animate__animated p-6 animate__fadeInDown">
                    ...
                    <div x-data="multipleTable">
                        <div class="panel mt-6">
                            <h5 class="md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light">Liste des stocks</h5>
                                    ...
                                    <table id="myTable2" class="whitespace-nowrap dataTable-table">
                                        ...
                                        <tbody>
                                            <?php foreach ($stocks as $row):?> 
                                                <tr>
                                                    <td><?php echo htmlspecialchars($row["id_stocks"]); ?></td>
                                                    ...
                                                    <button type=\"button\" class=\"ltr:mr-2 rtl:ml-2\" x-tooltip=\"Modifier\">
                                                        <a href=\"editer_un_stock.php?id=$row[id_stocks]\">
                                                    ...
                                                    <button type=\"button\" x-tooltip=\"Supprimer\" onClick=\"showAlert$row[id_stocks]()\">
                                                    <script>
                                                    async function showAlert$row[id_stocks]() {
                                                        new window.Swal({
                                                            icon: 'warning',
                                                            ...
                                                            if (result.value) {
                                                                ...
                                                                setTimeout(function() {
                                                                    window.location.href = \"supprimer_un_stock.php?id=$row[id_stocks]\";
                                                                  }, 1000);
                                                            }
                                                        });
                                                    }
