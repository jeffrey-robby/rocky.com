                ...
                <div class="animate__animated p-6 animate__fadeInDown">
                    ...
                    <div x-data="multipleTable">
                        <div class="panel mt-6">
                            <h5 class="md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light">Liste des personnels</h5>
                                    ...
                                    <table id="myTable2" class="whitespace-nowrap dataTable-table">
                                        <thead>
                                            <tr>
                                               ...
                                               <th data-sortable="" style="width: 22.2901%;">Téléphone</th>
                                               <th data-sortable="" style="width: 22.8532%;">Date de naissance</th>
                                               <th data-sortable="" style="width: 20.4881%;">Adresse email</th>
                                               <th data-sortable="" style="width: 20.4881%;">Poste</th>
                                               <th data-sortable="" style="width: 22.2901%;">Sexe</th>
                                               <th data-sortable="" style="width: 22.8532%;">Résidence</th>
                                               <th data-sortable="" style="width: 20.4881%;">Numéro de CNI</th>
                                               <th data-sortable="" style="width: 20.4881%;">Code</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($personnels as $row): ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo htmlspecialchars($row["prenom_personnels"]); ?></td>
                                                    <td><?php echo htmlspecialchars($row["tel_personnels"]); ?></td>
                                                    <td><?php echo htmlspecialchars($row["date_de_naissance_personnels"]); ?></td>
                                                    <td><?php echo htmlspecialchars($row["email_personnels"]); ?></td>
                                                    <td><?php echo htmlspecialchars($row["poste_personnels"]); ?></td>
                                                    <td><?php echo htmlspecialchars($row["sexe_personnels"]); ?></td>
                                                    <td><?php echo htmlspecialchars($row["residence_personnels"]); ?></td>
                                                    <td><?php echo htmlspecialchars($row["numero_cni_personnels"]); ?></td>
                                                    <td><?php echo htmlspecialchars($row["code_personnels"]); ?></td>
                                                    <td><?php  echo "<div class=\"flex items-center\">
                                                    <button type=\"button\" class=\"ltr:mr-2 rtl:ml-2\" x-tooltip=\"Modifier\">
                                                        <a href=\"editer_un_personnel.php?id=$row[id_personnels]\">
                                                    ...
                                                    <button type=\"button\" class=\"ltr:mr-2 rtl:ml-2\" x-tooltip=\"Voir\">
                                                        <a href=\"voir_un_personnel.php?id=$row[id_personnels]\">
                                                    ...
                                                    <button type=\"button\" x-tooltip=\"Supprimer\" onClick=\"showAlert$row[id_personnels]()\">
                                                    <script>
                                                    async function showAlert$row[id_personnels]() {
                                                        new window.Swal({
                                                            icon: 'warning',
                                                            ...
                                                            if (result.value) {
                                                                ...
                                                                setTimeout(function() {
                                                                    window.location.href = \"supprimer_un_personnel.php?id=$row[id_personnels]\";
                                                                  }, 1000);
                                                            }
                                                        });
                                                    }
